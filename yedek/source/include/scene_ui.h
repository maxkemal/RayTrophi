...
public:   
    ...
    struct TerrainBrushSettings {
        ...
        bool stroke_anchored = true; // Anchored stamp stroke support
    ...
    static inline bool isGrabFamilyTool(SculptBrushTool t) {
     ...
     struct SculptModeState {
        ...
        bool mirror_y = false;
        bool mirror_z = false;
        // Anchored stroke (Blender-style), used by the Stamp brush: fix the brush
        // centre at the click point and let the drag set the imprint depth + rotation
        // instead of painting along the path. Non-accumulating (single live imprint).
        bool stroke_anchored = true;
