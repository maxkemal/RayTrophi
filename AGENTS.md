...
- Template, startup, welcome-screen, guided-scene, or related UX work must follow `docs/TEMPLATE_HUB_UX_ROADMAP.md` as the canonical product direction. Preserve the viewport-first UI, reuse the existing left context rail/right contextual dock/bottom editor structure, and avoid introducing a large permanent shelf.
