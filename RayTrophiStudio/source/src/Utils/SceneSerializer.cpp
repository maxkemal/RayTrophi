...
json colliderToJson(const RayTrophiSim::ParticleColliderDesc& c) {
    ...
    j["gas_interaction_enabled"] = c.gas_interaction_enabled;
    j["gas_density_rate"] = c.gas_density_rate;
    j["gas_temperature_rate"] = c.gas_temperature_rate;
    j["gas_fuel_rate"] = c.gas_fuel_rate;
...
RayTrophiSim::ParticleColliderDesc jsonToCollider(const json& j) {
    ...
    if (j.contains("gas_interaction_enabled")) c.gas_interaction_enabled = j["gas_interaction_enabled"];
    if (j.contains("gas_density_rate")) c.gas_density_rate = j["gas_density_rate"];
    if (j.contains("gas_temperature_rate")) c.gas_temperature_rate = j["gas_temperature_rate"];
    if (j.contains("gas_fuel_rate")) c.gas_fuel_rate = j["gas_fuel_rate"];
...
json domainToJson(const RayTrophiSim::SimulationGridDomainDesc& d) {
    ...
    j["fluid_reseed_on_reset"] = d.fluid_reseed_on_reset;
    ...
    j["fluid_surface_fuel_capacity"] = d.fluid_surface_fuel_capacity;
...
RayTrophiSim::SimulationGridDomainDesc jsonToDomain(const json& j) {
    ...
    if (j.contains("fluid_reseed_on_reset")) d.fluid_reseed_on_reset = j["fluid_reseed_on_reset"];
    ...
    if (j.contains("fluid_surface_fuel_capacity")) d.fluid_surface_fuel_capacity = j["fluid_surface_fuel_capacity"];
