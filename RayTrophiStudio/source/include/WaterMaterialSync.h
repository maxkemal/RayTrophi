...
inline void applySurfaceParamsToPrincipledBSDF(const SurfaceParams& params, PrincipledBSDF& pbsdf) {
    ...
    pbsdf.setClearcoat(params.shore_foam_intensity, params.caustic_intensity);
    pbsdf.setSubsurface(params.depth_max / 100.0f);
    pbsdf.setSubsurfaceScale(params.absorption_density);
    pbsdf.setSubsurfaceColor(params.absorption_color);
    pbsdf.setSubsurfaceRadius(Vec3(params.shore_foam_distance, params.caustic_scale, params.sss_intensity));
    pbsdf.setSubsurfaceAnisotropy(params.caustic_speed);
