...
PNANOVDB_STATIC_CONST pnanovdb_uint32_t pnanovdb_grid_type_value_strides_bits[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_uint32_t[](  0u, 32u, 64u, 16u, 32u, 64u,  96u, 192u,  0u, 16u, 32u,  1u, 32u,  4u,  8u, 16u,  0u, 128u, 256u,  0u,  0u,  0u,  0u, 16u, 24u, 48u,  8u,  0u,  0u,  0u,  0u,  0u );
// bit count of the Tile union in InternalNodes, i.e. 8*sizeof(nanovdb::InternalData::Tile)
PNANOVDB_STATIC_CONST pnanovdb_uint32_t pnanovdb_grid_type_table_strides_bits[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_uint32_t[]( 64u, 64u, 64u, 64u, 64u, 64u, 128u, 192u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 128u, 256u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u );
// bit count of min/max values, i.e. 8*sizeof(nanovdb::LeafData::mMinimum) or zero if no min/max exists
PNANOVDB_STATIC_CONST pnanovdb_uint32_t pnanovdb_grid_type_minmax_strides_bits[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_uint32_t[](  0u, 32u, 64u, 16u, 32u, 64u,  96u, 192u,  8u, 16u, 32u,  8u, 32u, 32u, 32u, 32u, 32u, 128u, 256u, 64u, 64u,  0u,  0u, 64u, 24u, 48u,  8u,  0u,  0u,  0u,  0u,  0u );
...
PNANOVDB_STATIC_CONST pnanovdb_uint32_t pnanovdb_grid_type_minmax_aligns_bits[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_uint32_t[](  0u, 32u, 64u, 16u, 32u, 64u,  32u,  64u,  8u, 16u, 32u,  8u, 32u, 32u, 32u, 32u, 32u,  32u,  64u, 64u, 64u,  0u,  0u, 64u,  8u, 16u,  8u,  0u,  0u,  0u,  0u,  0u );
// bit alignment of the stats (avg/std-dev) types, e.g. 8*sizeof(nanovdb::LeafData::mAverage)
PNANOVDB_STATIC_CONST pnanovdb_uint32_t pnanovdb_grid_type_stat_strides_bits[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_uint32_t[](  0u, 32u, 64u, 32u, 32u, 64u,  32u,  64u,  8u, 32u, 32u,  8u, 32u, 32u, 32u, 32u, 32u,  32u,  64u, 64u, 64u,  0u,  0u, 64u, 32u, 32u, 32u,  0u,  0u,  0u,  0u,  0u );
// one of the 4 leaf types defined above, e.g. PNANOVDB_LEAF_TYPE_INDEX = 3
PNANOVDB_STATIC_CONST pnanovdb_uint32_t pnanovdb_grid_type_leaf_type[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_uint32_t[](  0u,  0u,  0u,  0u,  0u,  0u,  0u,    0u,  1u,  0u,  0u,  1u,  0u,  2u,  2u,  2u,  2u,   0u,   0u,  3u,  3u,  0u,  0u,  5u,  0u,  0u,  0u,  0u,  0u,  0u,  0u,  0u );
...
// ------------------------------------------------ Grid Type Constants Table -----------------------------------------------------------
// For GLSL: struct array constructors are unsupported in glslc at global scope.
// Use individual flat const uint[32] arrays + token-pasting macro instead.
#if defined(PNANOVDB_GLSL)
// BUF_CUSTOM path skips the BUF section which normally defines pnanovdb_grid_type_t.
// Define it here as a fallback so function signatures compile correctly.
#ifndef pnanovdb_grid_type_t
#define pnanovdb_grid_type_t uint
#endif
const uint pnanovdb_gtt_root_off_background[32]  = uint[32]( 28u, 28u, 32u, 28u, 28u, 32u, 28u, 32u, 28u, 28u, 28u, 28u, 28u, 28u, 28u, 28u, 28u, 28u, 32u, 32u, 32u, 28u, 28u, 32u, 28u, 28u, 28u, 28u, 28u, 28u, 28u, 28u );
const uint pnanovdb_gtt_root_off_min[32]          = uint[32]( 28u, 32u, 40u, 30u, 32u, 40u, 40u, 56u, 29u, 30u, 32u, 29u, 32u, 32u, 32u, 32u, 32u, 44u, 64u, 40u, 40u, 28u, 28u, 40u, 31u, 34u, 29u, 28u, 28u, 28u, 28u, 28u );
const uint pnanovdb_gtt_root_off_max[32]          = uint[32]( 28u, 36u, 48u, 32u, 36u, 48u, 52u, 80u, 30u, 32u, 36u, 30u, 36u, 36u, 36u, 36u, 36u, 60u, 96u, 48u, 48u, 28u, 28u, 48u, 34u, 40u, 30u, 28u, 28u, 28u, 28u, 28u );
const uint pnanovdb_gtt_root_off_ave[32]          = uint[32]( 28u, 40u, 56u, 36u, 40u, 56u, 64u,104u, 31u, 36u, 40u, 31u, 40u, 40u, 40u, 40u, 40u, 76u,128u, 56u, 56u, 28u, 28u, 56u, 40u, 48u, 32u, 28u, 28u, 28u, 28u, 28u );
const uint pnanovdb_gtt_root_off_stddev[32]       = uint[32]( 28u, 44u, 64u, 40u, 44u, 64u, 68u,112u, 32u, 40u, 44u, 32u, 44u, 44u, 44u, 44u, 44u, 80u,136u, 64u, 64u, 28u, 28u, 64u, 44u, 52u, 36u, 28u, 28u, 28u, 28u, 28u );
const uint pnanovdb_gtt_root_size[32]             = uint[32]( 32u, 64u, 96u, 64u, 64u, 96u, 96u,128u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 64u, 96u,160u, 96u, 96u, 32u, 32u, 96u, 64u, 64u, 64u, 32u, 32u, 32u, 32u, 32u );
const uint pnanovdb_gtt_value_stride_bits[32]     = uint[32](  0u, 32u, 64u, 16u, 32u, 64u, 96u,192u,  0u, 16u, 32u,  1u, 32u,  0u,  0u,  0u,  0u,128u,256u,  0u,  0u,  0u,  0u, 16u, 24u, 48u,  8u,  0u,  0u,  0u,  0u,  0u );
const uint pnanovdb_gtt_table_stride[32]          = uint[32](  8u,  8u,  8u,  8u,  8u,  8u, 16u, 24u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u, 16u, 32u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u,  8u );
const uint pnanovdb_gtt_root_tile_off_value[32]   = uint[32]( 20u, 20u, 24u, 20u, 20u, 24u, 20u, 24u, 20u, 20u, 20u, 20u, 20u, 20u, 20u, 20u, 20u, 20u, 24u, 24u, 24u, 20u, 20u, 24u, 20u, 20u, 20u, 20u, 20u, 20u, 20u, 20u );
const uint pnanovdb_gtt_root_tile_size[32]        = uint[32]( 32u, 32u, 32u, 32u, 32u, 32u, 32u, 64u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 64u, 64u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u, 32u );
const uint pnanovdb_gtt_upper_off_min[32]         = uint[32]( 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u, 8224u );
const uint pnanovdb_gtt_upper_off_max[32]         = uint[32]( 8224u, 8228u, 8232u, 8226u, 8228u, 8232u, 8236u, 8248u, 8225u, 8226u, 8228u, 8225u, 8228u, 8228u, 8228u, 8228u, 8228u, 8240u, 8256u, 8232u, 8232u, 8224u, 8224u, 8232u, 8227u, 8230u, 8225u, 8224u, 8224u, 8224u, 8224u, 8224u );
const uint pnanovdb_gtt_upper_off_ave[32]         = uint[32]( 8224u, 8232u, 8240u, 8228u, 8232u, 8240u, 8248u, 8272u, 8226u, 8228u, 8232u, 8226u, 8232u, 8232u, 8232u, 8232u, 8232u, 8256u, 8288u, 8240u, 8240u, 8224u, 8224u, 8240u, 8232u, 8236u, 8228u, 8224u, 8224u, 8224u, 8224u, 8224u );
const uint pnanovdb_gtt_upper_off_stddev[32]      = uint[32]( 8224u, 8236u, 8248u, 8232u, 8236u, 8248u, 8252u, 8280u, 8227u, 8232u, 8236u, 8227u, 8236u, 8236u, 8236u, 8236u, 8236u, 8260u, 8296u, 8248u, 8248u, 8224u, 8224u, 8248u, 8236u, 8240u, 8232u, 8224u, 8224u, 8224u, 8224u, 8224u );
const uint pnanovdb_gtt_upper_off_table[32]       = uint[32]( 8224u, 8256u, 8256u, 8256u, 8256u, 8256u, 8256u, 8288u, 8256u, 8256u, 8256u, 8256u, 8256u, 8256u, 8256u, 8256u, 8256u, 8288u, 8320u, 8256u, 8256u, 8224u, 8224u, 8256u, 8256u, 8256u, 8256u, 8224u, 8224u, 8224u, 8224u, 8224u );
const uint pnanovdb_gtt_upper_size[32]            = uint[32]( 270368u, 270400u, 270400u, 270400u, 270400u, 270400u, 532544u, 794720u, 270400u, 270400u, 270400u, 270400u, 270400u, 270400u, 270400u, 270400u, 270400u, 532576u, 1056896u, 270400u, 270400u, 270368u, 270368u, 270400u, 270400u, 270400u, 270400u, 270368u, 270368u, 270368u, 270368u, 270368u );
const uint pnanovdb_gtt_lower_off_min[32]         = uint[32]( 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u, 1056u );
const uint pnanovdb_gtt_lower_off_max[32]         = uint[32]( 1056u, 1060u, 1064u, 1058u, 1060u, 1064u, 1068u, 1080u, 1057u, 1058u, 1060u, 1057u, 1060u, 1060u, 1060u, 1060u, 1060u, 1072u, 1088u, 1064u, 1064u, 1056u, 1056u, 1064u, 1059u, 1062u, 1057u, 1056u, 1056u, 1056u, 1056u, 1056u );
const uint pnanovdb_gtt_lower_off_ave[32]         = uint[32]( 1056u, 1064u, 1072u, 1060u, 1064u, 1072u, 1080u, 1104u, 1058u, 1060u, 1064u, 1058u, 1064u, 1064u, 1064u, 1064u, 1064u, 1088u, 1120u, 1072u, 1072u, 1056u, 1056u, 1072u, 1064u, 1068u, 1060u, 1056u, 1056u, 1056u, 1056u, 1056u );
const uint pnanovdb_gtt_lower_off_stddev[32]      = uint[32]( 1056u, 1068u, 1080u, 1064u, 1068u, 1080u, 1084u, 1112u, 1059u, 1064u, 1068u, 1059u, 1068u, 1068u, 1068u, 1068u, 1068u, 1092u, 1128u, 1080u, 1080u, 1056u, 1056u, 1080u, 1068u, 1072u, 1064u, 1056u, 1056u, 1056u, 1056u, 1056u );
const uint pnanovdb_gtt_lower_off_table[32]       = uint[32]( 1056u, 1088u, 1088u, 1088u, 1088u, 1088u, 1088u, 1120u, 1088u, 1088u, 1088u, 1088u, 1088u, 1088u, 1088u, 1088u, 1088u, 1120u, 1152u, 1088u, 1088u, 1056u, 1056u, 1088u, 1088u, 1088u, 1088u, 1056u, 1056u, 1056u, 1056u, 1056u );
const uint pnanovdb_gtt_lower_size[32]            = uint[32]( 33824u, 33856u, 33856u, 33856u, 33856u, 33856u, 66624u, 99424u, 33856u, 33856u, 33856u, 33856u, 33856u, 33856u, 33856u, 33856u, 33856u, 66656u, 132224u, 33856u, 33856u, 33824u, 33824u, 33856u, 33856u, 33856u, 33856u, 33824u, 33824u, 33824u, 33824u, 33824u );
const uint pnanovdb_gtt_leaf_off_min[32]          = uint[32]( 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 88u, 88u, 88u, 88u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u, 80u );
const uint pnanovdb_gtt_leaf_off_max[32]          = uint[32]( 80u, 84u, 88u, 82u, 84u, 88u, 92u,104u, 80u, 82u, 84u, 80u, 84u, 90u, 90u, 90u, 90u, 96u,112u, 80u, 80u, 80u, 80u, 88u, 83u, 86u, 81u, 80u, 80u, 80u, 80u, 80u );
const uint pnanovdb_gtt_leaf_off_ave[32]          = uint[32]( 80u, 88u, 96u, 84u, 88u, 96u,104u,128u, 80u, 84u, 88u, 80u, 88u, 92u, 92u, 92u, 92u,112u,144u, 80u, 80u, 80u, 80u, 96u, 88u, 92u, 84u, 80u, 80u, 80u, 80u, 80u );
const uint pnanovdb_gtt_leaf_off_stddev[32]       = uint[32]( 80u, 92u,104u, 88u, 92u,104u,108u,136u, 80u, 88u, 92u, 80u, 92u, 94u, 94u, 94u, 94u,116u,152u, 80u, 80u, 80u, 80u, 96u, 92u, 96u, 88u, 80u, 80u, 80u, 80u, 80u );
const uint pnanovdb_gtt_leaf_off_table[32]        = uint[32]( 96u, 96u,128u, 96u, 96u,128u,128u,160u, 96u, 96u, 96u, 96u, 96u, 96u, 96u, 96u, 96u,128u,160u, 80u, 80u, 96u, 96u, 96u, 96u,128u, 96u, 96u, 96u, 96u, 96u, 96u );
const uint pnanovdb_gtt_leaf_size[32]             = uint[32]( 96u, 2144u, 4224u, 1120u, 2144u, 4224u, 6272u, 12448u, 96u, 1120u, 2144u, 160u, 2144u, 352u, 608u, 1120u, 96u, 8320u, 16544u, 96u, 96u, 96u, 96u, 1120u, 1632u, 3200u, 608u, 96u, 96u, 96u, 96u, 96u );
// Override PNANOVDB_GRID_TYPE_GET to use flat arrays (token-pasting via C preprocessor)
#undef PNANOVDB_GRID_TYPE_GET
#define PNANOVDB_GRID_TYPE_GET(grid_typeIn, nameIn) pnanovdb_gtt_##nameIn[grid_typeIn]
#else
// Non-GLSL: use original struct array (HLSL/C compilers handle this fine)
PNANOVDB_STATIC_CONST pnanovdb_grid_type_constants_t pnanovdb_grid_type_constants[PNANOVDB_GRID_TYPE_CAP] = pnanovdb_grid_type_constants_t[PNANOVDB_GRID_TYPE_CAP](
...
{
    pnanovdb_gridblindmetadata_handle_t meta; meta.address = grid.address ;
...
{
    pnanovdb_tree_handle_t tree; tree.address = grid.address ;
...
{
    pnanovdb_root_handle_t root; root.address = tree.address ;
...
{
    pnanovdb_root_tile_handle_t tile; tile.address = root.address ;
...
{
    pnanovdb_upper_handle_t upper; upper.address = root.address ;
...
PNANOVDB_FORCE_INLINE pnanovdb_root_tile_handle_t pnanovdb_root_find_tile(pnanovdb_grid_type_t grid_type, pnanovdb_buf_t buf, pnanovdb_root_handle_t root, PNANOVDB_IN(pnanovdb_coord_t) ijk)
{
    ...
    pnanovdb_root_tile_handle_t null_handle; null_handle.address = pnanovdb_address_null() ;
    return null_handle;
}
...
{
    pnanovdb_leaf_handle_t leaf; leaf.address = pnanovdb_address_offset_neg(min_address, PNANOVDB_GRID_TYPE_GET(PNANOVDB_GRID_TYPE_ONINDEX, leaf_off_table)) ;
...
{
    pnanovdb_leaf_handle_t leaf; leaf.address = pnanovdb_address_offset_neg(max_address, PNANOVDB_GRID_TYPE_GET(PNANOVDB_GRID_TYPE_ONINDEX, leaf_off_table)) ;
    pnanovdb_uint64_t idx = pnanovdb_uint32_as_uint64_low(0u);
    if (pnanovdb_leaf_onindex_has_stats(buf, leaf))
    {
...
{
    pnanovdb_leaf_handle_t leaf; leaf.address = pnanovdb_address_offset_neg(ave_address, PNANOVDB_GRID_TYPE_GET(PNANOVDB_GRID_TYPE_ONINDEX, leaf_off_table)) ;
    pnanovdb_uint64_t idx = pnanovdb_uint32_as_uint64_low(0u);
    if (pnanovdb_leaf_onindex_has_stats(buf, leaf))
    {
...
{
    pnanovdb_leaf_handle_t leaf; leaf.address = pnanovdb_address_offset_neg(dev_address, PNANOVDB_GRID_TYPE_GET(PNANOVDB_GRID_TYPE_ONINDEX, leaf_off_table)) ;
    pnanovdb_uint64_t idx = pnanovdb_uint32_as_uint64_low(0u);
    if (pnanovdb_leaf_onindex_has_stats(buf, leaf))
    {
...
{
    pnanovdb_uint32_t n = pnanovdb_leaf_coord_to_offset(ijk);
    pnanovdb_leaf_handle_t leaf; leaf.address = pnanovdb_address_offset_neg(value_address, PNANOVDB_GRID_TYPE_GET(PNANOVDB_GRID_TYPE_ONINDEX, leaf_off_table)) ;
...
{
    pnanovdb_leaf_handle_t leaf; leaf.address = lower.address ;
...
{
    pnanovdb_lower_handle_t lower; lower.address = upper.address ;
...
)
{
    ...
    if (level == 0)
    {
        ...
        pnanovdb_leaf_handle_t leaf; leaf.address = pnanovdb_address_offset_neg(value_address, PNANOVDB_GRID_TYPE_GET(PNANOVDB_GRID_TYPE_POINTINDEX, leaf_off_table) + 2u * n) ;
        if (n > 0u)
        {
