...
public:
    ...
    PrincipledBSDF(
        ...
        opacityProperty(Vec3(1.0f, 1.0f, 1.0f), 1.0f, opacityTexture),
    ...
    Vec3 getEmission(double u, double v, const Vec3& p) const {
        return  emissionProperty* emissionProperty.intensity; // Hacimde yoðunlukla deðiþen ýþýk emisyonu
...
private:
    ...
    static bool lutInitialized;  // Ýlk baþlatma kontrolü

    static void precomputeLUT(); // LUT'yi baþlatan fonksiyon
};
